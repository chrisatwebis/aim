...
<script>
	...
	/* 	$(".view-id-summary.view-display-id-page_3 .views-row-first ").append("<div class='see-more '><a class='arrowdown' href='#'>see more</a></div>");
		...
		$(".view-id-summary.view-display-id-page_3 .views-row .views-field-teaser").after("<div class='see-more '><a class='arrowdown' href='#'>see more</a></div>");
		$(".view-id-summary.view-display-id-page_3 .views-row .views-field-body").after("<div class='see-less '><a class='arrowup' href='#'>see less</a></div>");
		$(".view-id-summary.view-display-id-page_3 .views-row .views-field-body").hide();
		$(".see-more").click(
			function(e){
				e.preventDefault();
				$(this).parents(".views-row").find(".views-field-teaser").hide();
				$(this).parents(".views-row").find(".views-field-body").slideDown();
				//$(".view-id-summary.view-display-id-page_3 .views-row:not(.views-row-first)").slideDown();
			}
		);
		$(".see-less").click(
			function(e){
